...
class _NoteScreenState extends ConsumerState<NoteScreen> {
  ...
  final NoteLookController _noteLookController = NoteLookController();
              ...
              builder: (context, constraints) {
                return Stack(
                  children: [
                    ...
                    NoteLookOverlay(
                      settings: settings,
                      controller: _noteLookController,
                      colorNotifier: colorNotifier,
                      widthNotifier: widthNotifier,
                      toolNotifier: toolNotifier,
                      sketchNotifier: sketchNotifier,
                      selectionNotifier: selectionNotifier,
                      onAction: _undoRedoManager.applyAction,
                      onSettingsChanged: _settingsController.update,
                    ),
                  ],
                );
              },
